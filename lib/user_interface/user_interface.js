...
const AutoloadProcessor = require('./autoloads');

/**
 * This class represents the user interface.  It is the main controller for
 * all `blessed` components.
 */
class UserInterface extends EventEmitter {
    ...
    processAutoloads() {
        this.autoloader = new AutoloadProcessor(this).autoload();
        return true;
    }
